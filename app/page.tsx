  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-sky-50 to-white">
      ...
      <section className="max-w-4xl mx-auto px-6 py-24 text-center">
        ...
        <Link
          href="/book"
          className="inline-block bg-sky-600 hover:bg-sky-700 text-white font-semibold px-10 py-4 rounded-xl text-lg transition-colors shadow-lg shadow-sky-200"
        >
          Book Now
        </Link>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-6 pb-24 grid grid-cols-1 md:grid-cols-3 gap-8">
        {[
          ...
          <div key={item.step} className="bg-white rounded-2xl p-6 shadow-sm border border-sky-100">
            <div className="w-10 h-10 bg-sky-100 text-sky-700 rounded-full flex items-center justify-center font-bold text-lg mb-4">
              {item.step}
            </div>

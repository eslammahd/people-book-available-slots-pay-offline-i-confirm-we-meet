    ...
    <main className="min-h-screen bg-gradient-to-b from-teal-50 to-white">
      ...
      <section className="max-w-3xl mx-auto px-6 pt-20 pb-16 text-center">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6 leading-tight">
          ...
          <span className="text-teal-600">Better Mental Health</span>
        </h1>
        <p className="text-lg text-gray-600 mb-10 max-w-xl mx-auto">
          Book a therapy session with Dr. Saad in minutes. Choose a time that works for you and pay
          conveniently via Vodafone Cash.
        </p>
        <Link
          href="/book"
          className="inline-block bg-teal-600 text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-teal-700 transition shadow-lg"
        >
          Book Now
        </Link>
      </section>
